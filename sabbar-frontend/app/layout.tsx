...
export const metadata: Metadata = {
  ...
  description: 'Plateforme immobilière Marocaine — Achat, vente et location à Casablanca',
  icons: {
  ...
  openGraph: {
    title: 'LANDMARK ESTATE',
    description: 'Plateforme immobilière Marocaine — Achat, vente et location à Casablanca',
    url: 'https://landmarkk-estate.com',
    siteName: 'LANDMARK ESTATE',
    images: [
      {
        url: 'https://landmarkk-estate.com/og-image.png',
        width: 1200,
        height: 630,
        alt: 'LANDMARK ESTATE — Plateforme Immobilière Marocaine',
      },
    ],
    locale: 'fr_MA',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'LANDMARK ESTATE',
    description: 'Plateforme immobilière Marocaine — Achat, vente et location à Casablanca',
    images: ['https://landmarkk-estate.com/og-image.png'],
  },
};
