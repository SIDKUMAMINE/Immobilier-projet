          ...
          {selected && (
            <div style={{ background: '#fff', borderRadius: '12px', border: `1px solid ${T.borderSoft}`, padding: '24px', position: 'sticky', top: '24px', height: 'fit-content' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  <label style={{ fontSize: '11px', color: T.muted, textTransform: 'uppercase', block: 'inline-block', marginBottom: '4px' }}>Nom Complet</label>
                  <div style={{ fontSize: '14px', fontWeight: 500, color: T.navy }}>{selected.full_name || '—'}</div>
                </div>
                <div>
                  <label style={{ fontSize: '11px', color: T.muted, textTransform: 'uppercase', block: 'inline-block', marginBottom: '4px' }}>Message / Demande</label>
                ...
                <div>
                  <label style={{ fontSize: '11px', color: T.muted, textTransform: 'uppercase', block: 'inline-block', marginBottom: '6px' }}>Changer le Statut</label>
