    ...
    <main style={{ background: 'linear-gradient(to bottom, #0D1F3C, #050D1A)' }}>
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            Gateway Strategy: <span style={{ color: '#C8A96E' }}>Zéro Prospecting Waste</span>
          </h2>

          <div 
            className="max-w-3xl mx-auto rounded-2xl p-12"
            style={{
          ...
          >
            <div className="space-y-8">
              {[
                {
                  step: '1',
                  title: 'Approche Promoteur',
                  description: 'Proposer commercialisation exclusive complète'
                },
                {
                  step: '2',
                  title: 'Scénario Acceptation',
                  description: 'Contrat exclusif MAD 11.25M revenue ✓'
                },
                {
                  step: '3',
                  title: 'Scénario Rejet',
                  description: 'Proposer intermédiaton des unités restantes'
                },
                {
                  step: '4',
                  title: 'Vendre & Bâtir',
                  description: 'Vendre 5-10 unités en 3-4 mois, construire confiance'
                },
                {
                  step: '5',
                  title: 'Gagner Prochain',
                  description: 'Développeur voit résultats → Attribue prochain projet MAD 11.25M'
                }
              ].map((item, idx) => (
                <div key={idx}>
                  ...
                  {idx < 4 && (
                    <div 
                      className="h-8 border-l-2 ml-5 mt-4"
                      style={{
                        borderColor: 'rgba(200, 169, 110, 0.2)'
                      }}
                    />
            ...
            <div 
              className="mt-12 pt-8 border-t border-[rgba(200,169,110,0.2)]"
              style={{
                background: 'rgba(200, 169, 110, 0.05)',
                padding: '16px',
                borderRadius: '8px'
            ...
            >
              ...
              >
                ✅ Résultat: 100% Taux de Conversion<br/>
                <span style={{ fontSize: '14px', fontWeight: 400 }}>40-50% des rejections → intermédiaton | 30-50% de ces ventes → contrats futurs</span>
              </p>
            </div>
          </div>
        </div>
