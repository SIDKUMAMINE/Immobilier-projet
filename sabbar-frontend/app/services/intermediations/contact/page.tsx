...
export default function ContactIntermediationPage() {
  const [formData, setFormData] = useState({
    ...
    email: '',
    phone: '',
    subject: 'Intermédiation immobilière',
    budget: '',
    type: '',
    message: ''
  });
        ...
        <div className="ci-main-grid">
          ...
          <div className="ci-form-card">
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              >
                {loading
                  ? <><div style={{ animation: 'spin 1s linear infinite', borderRadius: '50%', height: '20px', width: '20px', border: '2px solid #0D1F3C', borderTopColor: 'transparent' }} /><span>Envoi...</span></>
                  : <><Send size={18} /><span>Envoyer ma demande</span></>
                }
              </button>
