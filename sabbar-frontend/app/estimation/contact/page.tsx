...
_Source : Page Estimation — LANDMARK ESTATE_`;
  ...
  const inputBase: React.CSSProperties = {
    ...
    background: 'rgba(13, 31, 60, 0.6)', border: '1px solid rgba(200, 169, 110, 0.18)',
  ...
  const LabelEl = ({ children, required }: { children: React.ReactNode; required?: boolean }) => (
    <label style={{
      ...
      textTransform: 'uppercase' as const, color: 'rgba(200, 169, 110, 0.7)',
      marginBottom: '8px', fontFamily: "'DM Sans', system-ui, sans-serif",
    }}>
      {children}
  ...
  const ChipSelect = ({ name, options, value, onChange }: {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Ambient glows — z-index:0, jamais bloquants */}
        ...
        {/* ✅ TOPBAR — position: relative + zIndex: 1
            Suppression de position:sticky et zIndex:100 qui créaient
            un contexte d'empilement bloquant le dropdown de la navbar globale */}
        <div style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Link
              ...
              style={{
                ...
                fontSize: '14px', fontWeight: 500, transition: 'gap 0.2s',
              }}
            ...
            <div style={{
              ...
              fontSize: '18px', fontWeight: 300, color: '#E2C98A', letterSpacing: '0.08em',
            }}>
              LANDMARK ESTATE
            </div>
          </div>
        ...
        <section style={{ padding: '72px 5% 56px', textAlign: 'center' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <div className="anim-fade anim-1" style={{
              ...
              background: 'rgba(200, 169, 110, 0.05)', marginBottom: '28px',
            }}>
              <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#C8A96E', display: 'inline-block', animation: 'pulse 2s infinite' }} />
              <span style={{ fontSize: '11px', fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#C8A96E', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
            ...
            <h1 className="anim-fade anim-2 hero-title" style={{
              ...
              color: '#F9F5EF', lineHeight: 1.1, marginBottom: '20px',
            }}>
            ...
            <p className="anim-fade anim-3" style={{
              fontFamily: "'DM Sans', system-ui, sans-serif",
              fontSize: '16px', fontWeight: 400, color: '#7A8FA3', lineHeight: 1.8,
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="two-col" style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '48px', alignItems: 'start' }}>
              ...
              <div className="anim-fade anim-2">
                ...
                {submitted && (
                  <div style={{
                    marginBottom: '28px', padding: '20px 24px', borderRadius: '12px',
                    ...
                    <div>
                      <p style={{ color: '#22c55e', fontWeight: 600, fontFamily: "'DM Sans', system-ui, sans-serif", marginBottom: '4px' }}>Message envoyé avec succès !</p>
                ...
                {error && (
                  <div style={{
                    ...
                    border: '1px solid rgba(181, 87, 58, 0.3)', background: 'rgba(181, 87, 58, 0.06)',
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div style={{ marginBottom: '36px' }}>
                    ...
                    <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                      <Field half>
                        ...
                        <input type="text" name="name" value={formData.name} onChange={handleChange} required placeholder="Votre nom et prénom" style={getInputStyle('name')} {...focusProps('name')} />
                      </Field>
                      <Field half>
                        <LabelEl>Téléphone</LabelEl>
                        <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+212 6 00 00 00 00" style={getInputStyle('phone')} {...focusProps('phone')} />
                      </Field>
                      <Field>
                        <LabelEl required>Adresse email</LabelEl>
                        <input type="email" name="email" value={formData.email} onChange={handleChange} required placeholder="votre@email.com" style={getInputStyle('email')} {...focusProps('email')} />
                      </Field>
                    </div>
                  </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                      <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        <Field half>
                          ...
                          <input type="text" name="ville" value={formData.ville} onChange={handleChange} required placeholder="Ex : Casablanca" style={getInputStyle('ville')} {...focusProps('ville')} />
                        </Field>
                        <Field half>
                          <LabelEl required>Quartier</LabelEl>
                          <input type="text" name="quartier" value={formData.quartier} onChange={handleChange} required placeholder="Ex : Maarif, Anfa..." style={getInputStyle('quartier')} {...focusProps('quartier')} />
                        </Field>
                      </div>
                      <div>
                        <LabelEl>Type de bien</LabelEl>
                        <ChipSelect name="typeBien" options={['Appartement', 'Villa', 'Riad', 'Bureau', 'Local commercial', 'Terrain']} value={formData.typeBien} onChange={v => setFormData(p => ({ ...p, typeBien: v }))} />
                      </div>
                      <div>
                        <LabelEl>Régime</LabelEl>
                        <ChipSelect name="regime" options={['Vente', 'Location']} value={formData.regime} onChange={v => setFormData(p => ({ ...p, regime: v }))} />
                      </div>
                      <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        <Field half>
                          <LabelEl>Superficie</LabelEl>
                          <input type="text" name="surface" value={formData.surface} onChange={handleChange} placeholder="Ex : 120 m²" style={getInputStyle('surface')} {...focusProps('surface')} />
                        </Field>
                        <Field half>
                          <LabelEl>Budget / Prix souhaité</LabelEl>
                          <input type="text" name="budget" value={formData.budget} onChange={handleChange} placeholder="Ex : 1,2 M MAD" style={getInputStyle('budget')} {...focusProps('budget')} />
                        </Field>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ marginBottom: '32px' }}>
                    ...
                    <textarea
                      ...
                      style={{ ...getInputStyle('message'), resize: 'none' }} {...focusProps('message')}
                    />
                  </div>
                  ...
                  <p style={{ textAlign: 'center', marginTop: '14px', fontSize: '12px', color: 'rgba(122, 143, 163, 0.7)', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
              ...
              <div className="side-panel anim-fade anim-3" style={{ position: 'sticky', top: '80px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ background: 'rgba(13, 31, 60, 0.7)', border: '1px solid rgba(200, 169, 110, 0.2)', borderRadius: '16px', padding: '28px', backdropFilter: 'blur(8px)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <a href="tel:+212605585720" style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#E2C98A', textDecoration: 'none', fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: '14px', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#C8A96E'} onMouseLeave={e => e.currentTarget.style.color = '#E2C98A'}>
                      <Phone size={15} style={{ color: '#C8A96E' }} /> +212 6 05 58 57 20
                    </a>
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#25D366', textDecoration: 'none', fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: '14px', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#4ade80'} onMouseLeave={e => e.currentTarget.style.color = '#25D366'}>
                      <span style={{ fontSize: '15px' }}>💬</span> WhatsApp — réponse rapide
                    </a>
                    <a href="mailto:Landmarkestate3@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#E2C98A', textDecoration: 'none', fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: '14px', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#C8A96E'} onMouseLeave={e => e.currentTarget.style.color = '#E2C98A'}>
        ...
        <div style={{ borderTop: '1px solid rgba(200,169,110,0.1)', padding: '24px 5%', textAlign: 'center' }}>
          <p style={{ fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: '12px', color: 'rgba(90, 110, 130, 0.8)' }}>
